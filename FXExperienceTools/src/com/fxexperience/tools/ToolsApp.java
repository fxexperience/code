...
public class ToolsApp extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
        ...
        Scene scene = new Scene(root);
         ...
         // Application icons
        Image image = new Image("/com/fxexperience/tools/images/FxExperienceToolsIcon-64.png");
        primaryStage.getIcons().addAll(image);
        primaryStage.setTitle("FX Experience Tools");
        scene.getStylesheets().add(ToolsApp.class.getResource("Tools.css").toString());
