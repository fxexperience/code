 ...
 *
 * {@literal @}keyframes bounceInDown { 0% { opacity: 0; -webkit-transform: translateY(-2000px);
 * } 60% { opacity: 1; -webkit-transform: translateY(30px); } 80% { -webkit-transform:
 * translateY(-10px); } 100% { -webkit-transform: translateY(0); } }
 *
 * @author Jasper Potts
 */
